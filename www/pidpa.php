...
if ($cmd=="s1"){
	...
	exec("sudo -u pi /usr/bin/irsend SEND_ONCE TV KEY_POWER KEY_POWER");
        ...
        exec("sudo -u pi /usr/bin/wakeonlan -i 192.168.1.255 54:B2:03:9B:E9:45");
}else if ($cmd=="roff"){
	...
	shell_exec("sudo -u pi ".$dir."roonRequest.sh playPause");
}else if ($cmd=="castPlayPause"){
        shell_exec("sudo -u pi ".$dir."castRequest.sh playPause");
}
